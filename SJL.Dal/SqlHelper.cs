...
namespace SJL.Dal
{
    ...
    {
        private static string dbProviderName = ConfigurationManager.ConnectionStrings["dataHC"].ProviderName;  //数据提供程序
        private static string dbConnectionString = ConfigurationManager.ConnectionStrings["dataHC"].ConnectionString;  //连接字符串
